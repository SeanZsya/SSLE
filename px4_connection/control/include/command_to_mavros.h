...
class command_to_mavros
{
    ...
    //发送速度，加速度期望到飞控
    void send_vel_acc_setpoint(const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_sp);
    void send_vel_acc_setpoint_yaw_rate(const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_vcc, float yaw_sp);

    //发送位置，速度，加速度，期望到飞控
    void send_all_setpoint(const Eigen::Vector3d& state_pos,const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_sp);
    void send_all_setpoint_yaw_rate(const Eigen::Vector3d& state_pos,const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_vcc, float yaw_sp);
...
void command_to_mavros::send_vel_setpoint(const Eigen::Vector3d& vel_sp, float yaw_sp)
{
    ...
    pos_setpoint.type_mask = 0b100000000111;
...
//发送速度，加速度期望值至飞控=========================================================================================
void command_to_mavros::send_vel_acc_setpoint(const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_sp)
{
    mavros_msgs::PositionTarget pos_setpoint;
    ...
    pos_setpoint.velocity.x = state_vel[0];
    pos_setpoint.velocity.y = state_vel[1];
    pos_setpoint.velocity.z = state_vel[2];

    pos_setpoint.acceleration_or_force.x = state_acc[0];
    pos_setpoint.acceleration_or_force.y = state_acc[1];
    pos_setpoint.acceleration_or_force.z = state_acc[2];
...
void command_to_mavros::send_vel_acc_setpoint_yaw_rate(const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_rate_sp)
{
    mavros_msgs::PositionTarget pos_setpoint;
...
//发送速度，加速度，位置期望值至飞控=========================================================================================
void command_to_mavros::send_all_setpoint(const Eigen::Vector3d& state_pos, const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_sp)
{
    mavros_msgs::PositionTarget pos_setpoint;
    ...
    pos_setpoint.position.x = state_pos[0];
    pos_setpoint.position.y = state_pos[1];
    pos_setpoint.position.z = state_pos[2];
...
void command_to_mavros::send_all_setpoint_yaw_rate(const Eigen::Vector3d& state_pos, const Eigen::Vector3d& state_vel,const Eigen::Vector3d& state_acc, float yaw_rate_sp)
{
    mavros_msgs::PositionTarget pos_setpoint;
